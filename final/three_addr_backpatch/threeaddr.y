...
while:	WHILE m OP bool CL m stmt {
									...
									instList[nextInst()]="goto "+too_string($2->instNum);
...
l: 	 ID AO e AC 
				{
					...
					instList[nextInst()]=$$->addr+" = "+$3->addr+" * "+too_string(getWidth($$->type));
				} |
		 l AO e AC
		 		{
		 			...
		 			instList[nextInst()]=myTemp->addr + " = "+$3->addr +" * "+too_string(getWidth($$->type));
