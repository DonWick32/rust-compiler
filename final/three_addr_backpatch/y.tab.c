...
{
       0,    83,    83,    83,    91,    92,    93,    94,    95,    96,
      98,   103,   110,   117,   117,   137,   142,   142,   143,   143,
     149,   149,   151,   151,   153,   153,   156,   158,   159,   167,
     178,   188,   190,   196,   202,   204,   205,   206,   213,   214,
...
#line 110 "threeaddr.y"
                                  {
									...
									instList[nextInst()]="goto "+too_string((yyvsp[-5].node)->instNum);
...
#line 168 "threeaddr.y"
					...
					instList[nextInst()]=(yyval.node)->addr+" = "+(yyvsp[-1].node)->addr+" * "+too_string(getWidth((yyval.node)->type));
				}
#line 1576 "y.tab.c"
    break;

  case 30: /* l: l AO e AC  */
#line 179 "threeaddr.y"
                                {
		 			...
		 			instList[nextInst()]=myTemp->addr + " = "+(yyvsp[-1].node)->addr +" * "+too_string(getWidth((yyval.node)->type));
...
#line 1590 "y.tab.c"
  ...
  case 31: /* r: e  */
#line 188 "threeaddr.y"
        {(yyval.node)=(yyvsp[0].node);}
#line 1596 "y.tab.c"
    break;

  case 32: /* bool: bool OR m bb  */
#line 190 "threeaddr.y"
                        {
					(yyval.node)=new NODE();
...
dagNode* getDAGNode(string name, string op)
{
	...
	x->op=op;
	x->resVars.push_back(name+"_"+too_string(dagVarCount[name]));
	dagVarCount[name]++;
	x->isGenerated=false;
	return x;
}
dagNode* getDAGNode(string name)
{
	...
	if(isInt(name))
	{
		...
		x->name=name+"_"+too_string(dagVarCount[name]);
	x->isGenerated=false;
	dagVarCount[name]++;
...
void genDAG(ll bno)
{
	...
	for(ll i=0;i<inst.size();i++)
	{
		...
		if(splits.size()==5)
		{
			...
			{
				res->resVars.push_back(splits[0]+"_"+too_string(dagVarCount[splits[0]]));
				dagMap[splits[0]]=res;
				continue;
			}
		...
		else if(splits.size()==3)
		{
			...
			{
				op1=dagMap[splits[2]];
				op1->resVars.push_back(splits[0]+"_"+too_string(dagVarCount[splits[0]]));
...
void genBasicBlock()
{
	...
	for(map<ll,string>::iterator it=instList.begin();it!=instList.end();it++)
	{
		...
		{
			bbinst=it->second.substr(0,ind+5) + too_string(lineToBlock[to_int(it->second.substr(ind+5))]);
		}
...
void backpatch(vector<ll> list,int num)
{
	for(ll i=0;i<list.size();i++)
	{
		...
		{
			instList[list[i]]+=" "+too_string(num);
		}
	}
}
void insertID(int bno,string varname)
...
int main()
{
	...
	instList[0] = "n = 10";
instList[1] = "t0 = low < high";
instList[2] = "if t1 != t0 goto 38";
instList[3] = "pivot = 0";
instList[4] = "t2 = low";
instList[5] = "t3 = arr[t2]";
instList[6] = "pivot = t3";
instList[7] = "i = low";
instList[8] = "t4 = low + 1";
instList[9] = "j = t4";
instList[10] = "t5 = j < high";
instList[11] = "if t5 != j goto 10";
instList[12] = "t7 = j";
instList[13] = "t8 = arr[t7]";
instList[14] = "t9 = t8 < pivot";
instList[15] = "if t9 goto 28";
instList[16] = "t10 = i + 1";
instList[17] = "i = t10";
instList[18] = "t11 = i";
instList[19] = "t12 = arr[t11]";
instList[20] = "t1 = t12";
instList[21] = "t13 = j";
instList[22] = "t14 = arr[t13]";
instList[23] = "t2 = t14";
instList[24] = "t12 = t2";
instList[25] = "t14 = t1";
instList[26] = "j = j + 1";
instList[27] = "goto 10";
instList[28] = "t15 = i";
instList[29] = "t16 = arr[t15]";
instList[30] = "t1 = t16";
instList[31] = "t17 = low";
instList[32] = "t18 = arr[t17]";
instList[33] = "t2 = t18";
instList[34] = "t16 = t2";
instList[35] = "t17 = t1";
instList[36] = "t19 = i + 1";
